...
export default defineConfig(({ mode }) => {
  ...
  const appEnv = {
    ...
    VITE_VIDEO_PRIMARY_TRANSPORT:
      env.VITE_VIDEO_PRIMARY_TRANSPORT ?? process.env.VITE_VIDEO_PRIMARY_TRANSPORT,
    VITE_VIDEO_FALLBACK_TRANSPORT:
      env.VITE_VIDEO_FALLBACK_TRANSPORT ?? process.env.VITE_VIDEO_FALLBACK_TRANSPORT,
    ...
    REACT_APP_VIDEO_PRIMARY_TRANSPORT: process.env.REACT_APP_VIDEO_PRIMARY_TRANSPORT,
    REACT_APP_VIDEO_FALLBACK_TRANSPORT: process.env.REACT_APP_VIDEO_FALLBACK_TRANSPORT,
